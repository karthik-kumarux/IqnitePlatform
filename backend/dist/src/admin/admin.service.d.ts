...
export declare class AdminService {
    ...
    getAllQuizzes(page?: number, limit?: number): Promise<{
        data: ({
            organizer: {
                id: string;
                email: string;
    ...
    searchUsers(searchTerm: string, role?: string, isActive?: boolean, page?: number, limit?: number): Promise<{
        data: {
            id: string;
            isActive: boolean;
            createdAt: Date;
    ...
    deleteQuiz(quizId: string, adminId: string): Promise<{
        message: string;
        errorCode: null;
    }>;
